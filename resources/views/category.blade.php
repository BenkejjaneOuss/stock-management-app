    ...
    <div class="row page-titles">
        <div class="col-md-12 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <button type="button" class="btn btn-info d-lg-block m-l-15" data-toggle="modal" data-target="#add-categorie"><i class="fa fa-plus-circle"></i> Ajouter une categorie</button>
                            ...
                            <tbody>
                                @foreach($categories as $category)
                                    <tr>
                                        <td>{{ $category->id }}</td>
                                        <td>{{ $category->name }}
                                        <button type="submit" onclick="updateName('{{$category->id}}','{{$category->name}}')" class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn"><i class="ti-pencil-alt" aria-hidden="true"></i></button>
                                        </td>
                                        <td>{{ $category->created_at }}</td>

                                        <td>
                                        <button type="submit" onclick="deleteCategory({{ $category->id }})" class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn"><i class="ti-close" aria-hidden="true"></i></button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
