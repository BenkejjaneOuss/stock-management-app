    ...
    <div class="row page-titles">
        <div class="col-md-12 align-self-center">
            <div class="d-flex justify-content-end align-items-center">
                <button type="button" class="btn btn-info d-lg-block"  data-toggle="modal" data-target="#add-product-purchase"><i class="fa fa-cart-plus"></i> Ajouter un achat</button>
                <div id="add-product-purchase" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            </div>
                            <form class="form-horizontal" action="/addProductPurchase" method="post">
                            @csrf
                            <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 m-b-20">
                                            <input type="text" class="form-control" placeholder="Prix d'achat" name="purchasing_price" pattern="[0-9]+(\.[0-9]{0,2})?%?" required="true">
                                        </div>
                                        <div class="col-md-12 m-b-20">
                                            <select id="supplierP" placeholder="Choisissez un fournisseur..." name="supplier_id" required="true">
